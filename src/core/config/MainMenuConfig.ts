...
const DocMenuConfig = [
  {
    pages: [
      {
        heading: "سر فصل مطالب",
        route: "/dashboard",
        svgIcon: publicPath+"media/icons/duotune/general/gen025.svg",
      },
      {
        sectionTitle: "جاوا اسکریپت",
        route: "/javascript",
        svgIcon: publicPath+"media/icons/duotune/ecommerce/ecm007.svg",
        sub: [
          {
            heading: "معرفی",
            route: "/javascript/intro",
          },
          {
            heading: "محل اجرا",
            route: "/javascript/run",
          },
          {
            heading: "دستورات خروجی",
            route: "/javascript/output",
          },
          {
            heading: "داده ها",
            route: "/javascript/data",
          },
          {
            heading: "تابع",

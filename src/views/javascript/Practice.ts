...
`,
    ...
    {
        title: 'پیاده سازی ساختار مدیریتی (افزودن، ویرایش، حذف، مرتب سازی و جستجو) روی داده تمرین قبل',
        text: [
            {
                title: ``,
                code: ``,
